...
local-miui-modified-apps := Browser DeskClock DownloadProvider MiuiCompass miuisystem MiuiHome MiuiSuperMarket SoundRecorder TeleService Updater XiaomiServiceFramework
