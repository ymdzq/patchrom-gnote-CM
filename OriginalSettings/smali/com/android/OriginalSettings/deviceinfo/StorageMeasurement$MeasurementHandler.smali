...
.field private mCached:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
...
.method public constructor <init>(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-boolean v0, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mBound:Z
...
.method static synthetic access$102(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$202(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private measureApproximateStorage(Lcom/android/internal/app/IMediaContainerService;)V
    ...
    #getter for: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/StorageVolume;
    invoke-static {v3}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$400(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v3, v4, v5}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$502(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;J)J
    ...
    invoke-static {v3, v4, v5}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$602(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;J)J
    :try_end_0
    ...
    invoke-static {v3}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$700(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)V
...
.method private measureExactStorage(Lcom/android/internal/app/IMediaContainerService;)V
    ...
    iget-object v4, v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mContext:Ljava/lang/ref/WeakReference;
    ...
    :cond_2
    new-instance v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;

    invoke-direct {v5}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;-><init>()V

    .line 401
    .local v5, details:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
    const/4 v4, 0x4

    move-object/from16 v0, p0

    invoke-virtual {v0, v4, v5}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v4, v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->this$0:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;

    #getter for: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mTotalSize:J
    invoke-static {v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$500(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)J

    move-result-wide v25

    move-wide/from16 v0, v25

    iput-wide v0, v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;->totalSize:J
    ...
    #getter for: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mAvailSize:J
    invoke-static {v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$600(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)J

    move-result-wide v25

    move-wide/from16 v0, v25

    iput-wide v0, v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;->availSize:J
    ...
    invoke-static {v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$800(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Z
    ...
    invoke-static {v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$900(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Z
    ...
    .line 418
    invoke-static {}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$1000()Ljava/util/Set;
    ...
    #calls: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    invoke-static {v0, v1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$1100(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J

    move-result-wide v18

    .line 421
    .local v18, size:J
    iget-object v4, v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;->mediaSize:Ljava/util/HashMap;
    ...
    #calls: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    invoke-static {v4, v0, v1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$1200(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J

    move-result-wide v25

    move-wide/from16 v0, v25

    iput-wide v0, v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;->miscSize:J
    ...
    #calls: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    invoke-static {v0, v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$1100(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J

    move-result-wide v18

    .line 437
    .restart local v18       #size:J
    iget-object v4, v5, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;->usersSize:Landroid/util/SparseLongArray;
    ...
    #calls: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->addValue(Landroid/util/SparseLongArray;IJ)V
    invoke-static {v4, v0, v1, v2}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$000(Landroid/util/SparseLongArray;IJ)V
    ...
    #getter for: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/StorageVolume;
    invoke-static {v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$400(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Landroid/os/storage/StorageVolume;
    ...
    .line 448
    .local v8, count:I
    new-instance v3, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$StatsObserver;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$StatsObserver;-><init>(ZLcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;ILandroid/os/Message;I)V

    .line 451
    .local v3, observer:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$StatsObserver;
    invoke-interface/range {v24 .. v24}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 458
    .end local v3           #observer:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$StatsObserver;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 326
    :pswitch_0
    iget-object v3, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mCached:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
    ...
    iget-object v4, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mCached:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;

    #calls: Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sendExactUpdate(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
    invoke-static {v3, v4}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->access$300(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
    ...
    check-cast v3, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;

    iput-object v3, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mCached:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
    ...
    .line 374
    :pswitch_4
    iput-object v0, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementHandler;->mCached:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
