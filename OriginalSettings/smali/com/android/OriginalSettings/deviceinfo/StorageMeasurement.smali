...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$StatsObserver;,
        Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;,
        Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
    ...
    sput-object v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;)V
    ...
    .line 168
    iput-object p2, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/StorageVolume;
...
.method static synthetic access$000(Landroid/util/SparseLongArray;IJ)V
    ...
    .prologue
    .line 62
    invoke-static {p0, p1, p2, p3}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->addValue(Landroid/util/SparseLongArray;IJ)V
...
.method static synthetic access$1000()Ljava/util/Set;
    ...
    .prologue
    .line 62
    sget-object v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
...
.method static synthetic access$1100(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    .prologue
    .line 62
    invoke-static {p0, p1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
...
.method static synthetic access$1200(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    .locals 2
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 62
    invoke-direct {p0, p1, p2}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
...
.method static synthetic access$300(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 62
    invoke-direct {p0, p1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sendExactUpdate(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V

    return-void
.end method

.method static synthetic access$400(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Landroid/os/storage/StorageVolume;
    .locals 1
    .parameter "x0"

    .prologue
    .line 62
    iget-object v0, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mVolume:Landroid/os/storage/StorageVolume;

    return-object v0
.end method

.method static synthetic access$500(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)J
    .locals 2
    .parameter "x0"
...
.method static synthetic access$600(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)J
    .locals 2
    .parameter "x0"

    .prologue
    .line 62
    iget-wide v0, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mAvailSize:J
...
.method static synthetic access$700(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$800(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$900(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;)Z
    .locals 1
    .parameter "x0"
...
.method public static getInstance(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;
    .locals 3
    .parameter "context"
    .parameter "volume"
    ...
    .prologue
    .line 89
    sget-object v2, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;

    monitor-enter v2

    .line 90
    :try_start_0
    sget-object v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;

    invoke-virtual {v1, p1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;

    .line 91
    .local v0, value:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;
    if-nez v0, :cond_0

    .line 92
    new-instance v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;

    .end local v0           #value:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;
    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1, p1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;-><init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;)V

    .line 93
    .restart local v0       #value:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;
    sget-object v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sInstances:Ljava/util/HashMap;
...
.method private measureMisc(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    iput-object v1, v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mFileInfoForMisc:Ljava/util/List;
    ...
    .local v3, fileSize:J
    :goto_3
    sget-object v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->sMeasureMediaTypes:Ljava/util/Set;
    ...
    iget-object v7, v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mFileInfoForMisc:Ljava/util/List;

    new-instance v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$FileInfo;
    ...
    .end local v5           #counter:J
    .local v15, counter:J
    invoke-direct/range {v1 .. v6}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$FileInfo;-><init>(Ljava/lang/String;JJ)V
    ...
    invoke-static {v0, v1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->getDirectorySize(Lcom/android/internal/app/IMediaContainerService;Ljava/io/File;)J
    ...
    iget-object v1, v0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mFileInfoForMisc:Ljava/util/List;

    new-instance v7, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$FileInfo;
    ...
    invoke-direct/range {v7 .. v12}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$FileInfo;-><init>(Ljava/lang/String;JJ)V
...
.method private sendExactUpdate(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
    .locals 3
    .parameter "details"

    .prologue
    .line 209
    iget-object v1, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mReceiver:Ljava/lang/ref/WeakReference;
    ...
    check-cast v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;

    move-object v0, v1

    .line 210
    .local v0, receiver:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;
    :goto_0
    if-nez v0, :cond_2

    .line 211
    sget-boolean v1, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->LOGV:Z
    ...
    .line 209
    .end local v0           #receiver:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;
    :cond_1
    const/4 v0, 0x0
    ...
    .line 216
    .restart local v0       #receiver:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;
    :cond_2
    invoke-interface {v0, p0, p1}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;->updateDetails(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
...
.method private sendInternalApproximateUpdate()V
    ...
    .restart local v0       #receiver:Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;
    :cond_1
    iget-wide v2, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mTotalSize:J

    iget-wide v4, p0, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;->mAvailSize:J

    move-object v1, p0

    invoke-interface/range {v0 .. v5}, Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement$MeasurementReceiver;->updateApproximate(Lcom/android/OriginalSettings/deviceinfo/StorageMeasurement;JJ)V
